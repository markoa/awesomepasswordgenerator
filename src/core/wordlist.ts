 ...
 * SPEC §6.6: Wordlist must be embedded locally (no network)
 * 
 * This is a curated list of common English words suitable for passphrases.
 * Words are chosen to be:
 * - Easy to remember and type
 * - Common enough to be recognizable
 * - Short enough to keep passphrases manageable
 * 
 * Size: 2048 words (2^11) providing ~11 bits of entropy per word
 */
...
export const WORDLIST: readonly string[] = [
  ...
  'lounge', 'love', 'low', 'loyal', 'lucky', 'luggage', 'lumber', 'lunar',
  'lunch', 'lung', 'luxury', 'lyrics', 'machine', 'mad', 'magic', 'magnet',
  ...
  'pepper', 'perfect', 'perform', 'period', 'permit', 'person', 'pet', 'phone',
  ...
  'push', 'put', 'pyramid', 'quality', 'quantum', 'quarter', 'question', 'quick',
  ...
  'repeat', 'replace', 'reply', 'report', 'require', 'rescue', 'resemble', 'resist',
  ...
  'run', 'runway', 'rural', 'sad', 'saddle', 'safe', 'sail', 'salad',
  ...
  'weave', 'web', 'wedding', 'weekend', 'weird', 'welcome', 'weld', 'well',
  ...
  'word', 'work', 'world', 'worry', 'worth', 'would', 'wound', 'wrap',
